...
class TestEndToEndWorkflow:
    ...
    def test_workflow_run_resume(self, client):
        ...
        # Resume run
        resume_response = client.post(f"/api/v2/workflow-runs/{run_id}/resume")
...
class TestOnboardingE2E:
    ...
    def test_onboarding_event_tracking_e2e(self, client, sample_brand):
        ...
        events = [
            {"event_type": "step_1", "brand_id": brand_id, "payload": {"step": 1}},
            {"event_type": "step_2", "brand_id": brand_id, "payload": {"step": 2}},
            {"event_type": "step_3", "brand_id": brand_id, "payload": {"step": 3}},
        ]
